...
Review-project is an activity created on the second week to show how we can review our projects

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

The project is to determine the basic knowledge one has in git,HTML5,CSS.
